...
const Header = ({ theme }) => (
    <header className={theme === 'light' ? 'header header--light' : 'header'}>
        <div className='header__brand'>
            <img className={theme === 'light' ? 'header__brand__logo header__brand__logo--light' : 'header__brand__logo'} alt='UpMiner' src={logo} />
            <div className='header__brand__vertical-bar'></div>
            <div className='header__brand__title'>Histórico Empresarial</div>
        </div>
        <div className={theme === 'light' ? 'header__text header__text--light' : 'header__text'}>
